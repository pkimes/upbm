---
title: "PBMExperiment: Analysis of Protein Binding Microarrays in R"
author: Patrick K. Kimes
date: "`r BiocStyle::doc_date()`"
package: "`r BiocStyle::pkg_ver('PBMExperiment')`"
output:
  BiocStyle::html_document:
    ...
    fig_height: 4
vignette: >
  %\VignetteIndexEntry{Analysis with PBMExperiment}
...
```{r, eval = FALSE}
system.time({ pbm_predict <- predictKmers(pbmdat400_norm, verbose = TRUE) })
```
