...
kmerFit <- function(se, method = c("dl2", "dl")) {
    ...
    alist <- list(betaFE = .tidynested2mat(adat, kmers, "betaFE"),
                  varFE = .tidynested2mat(adat, kmers, "varFE"),
                  betaME = .tidynested2mat(adat, kmers, "betaME"),
                  varME = .tidynested2mat(adat, kmers, "varME"),
                  tau2 = .tidynested2mat(adat, kmers, "tau2"))
...
## helper to turn entry in tidy table list column into matrix for SE
.tidynested2mat <-  function (x, km, cn) {
